...
function moveSnake() {
  ...
  */
  for (var s = snake.body.length - 1; s > 0; s--) {
    var snakeSquare = snake.body;
...
function hasCollidedWithSnake() {
  ...
  */
  if (snake.head.row === snake.body.row) {
    return true;
  }
  else if ( snake.head.row !== snake.body.row) {
    return false;
  }
  if (snake.head.column === snake.body.column) {
    return true;
  }
  else if (snake.head.column !== snake.body.column) {
    return false;
  }
